...
public class AdventOfCode_2021_08 {
	...
	public static void main(String... args) {
		...
		for (String last : input.split("\n")) {
			...
			for (String number : first.split(" ")) {
				if (number.length() == 6) {
					if (AdventOfCodeUtil.stringContains(number, number1) && AdventOfCodeUtil.stringContains(number, number7)
							&& !AdventOfCodeUtil.stringContains(number, number4)) {
						number0 = number;
					} else if (AdventOfCodeUtil.stringContains(number, number1) && AdventOfCodeUtil.stringContains(number, number7)
							&& AdventOfCodeUtil.stringContains(number, number4)) {
						number9 = number;
					} else if (!AdventOfCodeUtil.stringContains(number, number1) && !AdventOfCodeUtil.stringContains(number, number7)
							&& !AdventOfCodeUtil.stringContains(number, number4)) {
				...
				if (number.length() == 5) {
					if (AdventOfCodeUtil.stringContains(number, number7)) {
						number3 = number;
					} else if (AdventOfCodeUtil.stringCountInstances(number, number4) == 2) {
						number2 = number;
					} else if (AdventOfCodeUtil.stringCountInstances(number, number4) == 3) {
						number5 = number;
					}
				}
			}
			...
			String result = "";
			for (String number : last.split(" ")) {
				if (number.length() == number0.length() && AdventOfCodeUtil.stringCountInstances(number, number0) == 6) {
					result = result + "0";
				}
				if (number.length() == number1.length()) {
					result = result + "1";
				}
				if (number.length() == number2.length() && AdventOfCodeUtil.stringCountInstances(number, number2) == 5) {
					result = result + "2";
				}
				if (number.length() == number3.length() && AdventOfCodeUtil.stringCountInstances(number, number3) == 5) {
					result = result + "3";
				}
				if (number.length() == number4.length()) {
					result = result + "4";
				}
				if (number.length() == number5.length() && AdventOfCodeUtil.stringCountInstances(number, number5) == 5) {
					result = result + "5";
				}
				if (number.length() == number6.length() && AdventOfCodeUtil.stringCountInstances(number, number6) == 6) {
					result = result + "6";
				}
				if (number.length() == number7.length()) {
					result = result + "7";
				}
				if (number.length() == number8.length()) {
					result = result + "8";
				}
				if (number.length() == number9.length() && AdventOfCodeUtil.stringCountInstances(number, number9) == 6) {
					result = result + "9";
				}
