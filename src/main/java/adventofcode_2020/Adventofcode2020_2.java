...
public class Adventofcode2020_2 {

    static String input = "3-5 f: fgfff\n" +
    ...
    public static void main(String... args) {
        ...
        for (String s : inputs) {
            ...
            int max = Integer.parseInt(s.substring(s.indexOf("-") + 1, s.indexOf("-") + 3).trim());
            String letter = s.substring(s.indexOf(":")- 1, s.indexOf(":"));
            String string = s.substring(s.indexOf(":") + 2);
            long count = string.chars().filter(ch -> ch == letter.charAt(0)).count();
    ...
    private static class Coordinate {
        ...
        public boolean equals(Coordinate coordinate) {
            return coordinate.xvalue == this.xvalue && coordinate.yvalue == this.yvalue;
        }
